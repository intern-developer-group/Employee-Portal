        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6 class="text-center">Absent Attendance</h6>
            </div>
                ...
                <table class="table align-items-center mb-0" id="data">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-xs font-weight-bolder opacity-8">Name
                      </th>
                  ...
                  <tbody>
                    ...
                    $update_month = date("m");
                    $update_year = date("Y");
                    $result = mysqli_query($con, "SELECT * from attendance where user_id='$userid' and attendance_status='0' and attendance_date <= '$today_date' and month(attendance_date) = '$update_month' and year(attendance_date) = '$update_year' or user_id='$userid' and attendance_status='3' and attendance_date <= '$today_date' and month(attendance_date) = '$update_month' and year(attendance_date) = '$update_year'");
